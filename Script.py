...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/H21tg_bot>☢VJ☢</a></b>
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    IMDB_TEMPLATE_TXT = """
<b>{qurey} ɪs ᴀᴠᴀɪʟᴀʙʟᴇ ✅

<b>✒️ Tɪᴛʟᴇ</b>: <a href={url}>{title}</a>
📆 Yᴇᴀʀ : <a href={url}/releaseinfo>{year}</a>
🎧 Lᴀɴɢᴜᴀɢᴇs : <code>{languages}</code>
📀 Rᴜɴᴛɪᴍᴇ: {runtime} Mɪɴᴜᴛᴇs</code>

⏱️ Rᴇsᴜʟᴛ sʜᴏᴡɴ ɪɴ: {remaining_seconds} <i>seconds</i> 
🐱 Rᴇǫᴜᴇsᴛᴇᴅ ʙʏ : {message.from_user.mention}</b>"""
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த MALLUFILES BOT போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this MALLUFILES BOT bot to your group
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ MALLUFILES BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس MALLUFILES BOT بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ MALLUFILES BOT બોટનું સંચાલન કરો
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই MALLUFILES BOT বট পরিচালনা করুন
...
-Dev 1 [Owner of this bot ]<a href='https://t.me/H21tg_bot'>VJ</a>
